...
export default function Kinesiologia() {
   return (
      <section className="flex items-center flex-col">
         <div className="w-full px-20 md:w-3/4 text-justify  p-5 bg-slate-100 md:rounded-xl dark:bg-slate-600  mt-16">
            <h2 className="text-3xl text-center md:text-left mb-4 font-bold ">
               Pilates
            </h2>
